...
class CreateInternalSeventyPercentMarksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('internal_seventy_percent_marks', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('internal_seventy_percent_marks');
    }
}
